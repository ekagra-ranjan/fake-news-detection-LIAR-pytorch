...
class Net(nn.Module):
	...
	def __init__(self,
		...
		self.fc_query = nn.Linear(self.query_dim, self.statement_embed_dim)
		self.fc_att = nn.Linear(self.statement_embed_dim, self.statement_embed_dim)
		self.fc_conv = nn.Linear(self.statement_embed_dim, self.statement_embed_dim)
		self.fc_cat = nn.Linear(self.statement_embed_dim, self.statement_embed_dim)
	...
	def forward(self, sample):
		...
		query = F.relu(self.fc_query(query))
